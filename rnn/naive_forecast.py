...
plt.tight_layout()
plt.savefig("./fig/naive_loss_curve.png")
plt.show()
plt.close()
#%%
...
plt.title(f"Test dataset 예측 결과", fontsize=15)
plt.grid(alpha=0.3)
plt.legend(fontsize=14)
plt.tight_layout()
plt.savefig("./fig/naive_forecast.png")
plt.show()
plt.close()
#%%
plt.figure(figsize=(10, 4))
plt.plot(forecast_scaled[1:], linewidth=1, label="Forecasting (lag 1)")
plt.plot(true_scaled[:-1], linewidth=1, label="Test")
plt.xlabel("timestep", fontsize=14)
plt.ylabel("T (degC)", fontsize=14)
plt.title(f"Test dataset 예측 결과 (lag 1)", fontsize=15)
plt.grid(alpha=0.3)
plt.legend(fontsize=14)
plt.tight_layout()
plt.savefig("./fig/naive_forecast_lag1.png")
plt.show()
plt.close()
#%%