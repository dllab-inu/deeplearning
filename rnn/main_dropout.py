...
class Forecaster(nn.Module):
    def __init__(self, configs):
        ...
        self.proj = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(configs['drop_ratio']), # dropout layer
            nn.Linear(configs['hidden_dim'], configs['feature_dim'])
        )
...
plt.tight_layout()
plt.savefig("./fig/dropout_loss_curve.png")
plt.show()
plt.close()
#%%
...
plt.tight_layout()
plt.savefig("./fig/dropout_forecast.png")
plt.show()
plt.close()
#%%