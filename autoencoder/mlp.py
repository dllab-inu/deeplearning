...
plt.tight_layout()
plt.savefig(f"./fig/loss_curve_mlp.png")
plt.show()
plt.close()
#%%
...
plt.tight_layout()
plt.savefig(f"./fig/reconstruction_mlp.png")
plt.show()
plt.close()
#%%
z_list, label_list = [], []
...
plt.tight_layout()
plt.savefig(f"./fig/latent_scatter_mlp.png")
plt.show()
plt.close()
#%%
n_grid = 15
...
plt.tight_layout()
plt.savefig(f"./fig/latent_manifold_mlp.png", bbox_inches='tight')
plt.show()
plt.close()
#%%